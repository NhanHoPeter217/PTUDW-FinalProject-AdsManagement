...
:::info **Yêu cầu**: xây dựng bộ ứng dụng web **Quản lý bảng quảng cáo** cho thành phố X gồm các
...
-   Ứng dụng cho phép người dân ẩn/hiện các báo cáo, các điểm đặt quảng cáo đã quy hoạch / chưa quy
    hoạch trên bản đồ
