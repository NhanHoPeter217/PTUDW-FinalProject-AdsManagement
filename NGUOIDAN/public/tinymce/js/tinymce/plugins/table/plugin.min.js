...
!(function () {
    ...
    const ie = (e, t, o) => {
        ...
        Oe = (e, t, o) =>
            e.isSome() && t.isSome() ? y.some(o(e.getOrDie(), t.getOrDie())) : y.none(),
        _e = (e, t) =>
    ...
    const st = I(5, (e) => {
        ...
        Dt = (e) => {
            ...
            return t.isSet('table_default_styles')
                ? o
                : ((e, t) =>
                      _t(e) || !St(e) ? t : Ot(e) ? { ...t, width: mt(e) } : { ...t, width: it })(
                      e,
                      o
                  );
        },
            ...
            const l = M(t, (e) => {
                return {
                    ...
                    value:
                        ...
                        ((o = e.value),
                        ((t = o),
                        ((e) => lo.test(e) || no.test(e))(t) ? y.some({ value: ro(t) }) : y.none())
                            .orThunk(() => po(o).map(so))
                            .getOrThunk(() => {
