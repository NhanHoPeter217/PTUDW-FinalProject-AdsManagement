...
!(function () {
    ...
    const G = (e) => s(e) && 'a' === e.nodeName.toLowerCase(),
        ...
        re = (e) => {
            ...
            return (
                !!n.collapsed || 0 === J(n, (e) => 1 === e.nodeType && !G(e) && !V(t, e.nodeName.toLowerCase())).length
            );
        },
        ...
        me = (e, t) => {
            const n = { text: e.text, title: e.title },
                o = (e, o) => {
                    const r = ((l = t), (i = o), 'link' === i ? l.link : 'anchor' === i ? l.anchor : m.none()).getOr(
                        []
                    );
                    var l, i;
                    return ((e, t, n, o) => {
        ...
        ((e) => {
            ...
            ((e) => {
                e.ui.registry.addContextMenu('link', {
                    update: (t) =>
                        e.dom.isEditable(t) ? (oe(e.dom.getParents(t, 'a')) ? 'link unlink openlink' : 'link') : ''
                });
            })(e),
            ((e) => {
                const t = (t) => {
