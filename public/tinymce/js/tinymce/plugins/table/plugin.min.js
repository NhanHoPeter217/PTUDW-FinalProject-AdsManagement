    ...
    const jt = (e, t, o, l) => {
        ...
        Po = (e, t, o) => {
            const l = ((e) => {
                ...
                M(t.selection, (t) => {
                    return ((l = t),
                    ((e, t, o = h) =>
                        o(t) ? y.none() : D(e, G(t)) ? y.some(t) : me(t, e.join(','), (e) => $(e, 'table') || o(e)))(
                        ['td', 'th'],
                        l,
                        n
                    ))
        ...
        Ko = (e) => {
            ...
            const o = ((e, t) => {
                ...
                l = {
                    type: 'tabpanel',
                    tabs: [{ title: 'General', name: 'general', items: Ro(e) }, Oo(e, 'cell')]
                },
                n = {
                    type: 'panel',
        ...
        Yo = (e) => {
            ...
            const o = M(t, (t) =>
                ...
                n = {
                    type: 'tabpanel',
                    tabs: [{ title: 'General', name: 'general', items: Qo(e) }, Oo(e, 'row')]
                },
                r = {
                    type: 'panel',
        ...
        ol = (e, t) => {
            ...
            const a = { type: 'grid', columns: 2, items: Zo(e, r, t) },
                s = ft(e)
                    ? {
                          type: 'tabpanel',
                          tabs: [{ title: 'General', name: 'general', items: [a] }, Oo(e, 'table')]
                      }
                    : { type: 'panel', items: [a] };
            e.windowManager.open({
            ...
            ((e, t) => {
                ...
                0 !== m.length &&
                    ...
                    e.ui.registry.addNestedMenuItem('tableclass', {
                        ...
                        text: 'Table styles',
                        getSubmenuItems: () =>
                            yo(e, m, 'tableclass', (t) => e.execCommand('mceTableToggleClass', !1, t)),
                        onSetup: t.onSetupTable
                    });
                const u = So(Ct(e));
                0 !== u.length &&
                    ...
                    e.ui.registry.addNestedMenuItem('tablecellclass', {
                        ...
                        text: 'Cell styles',
                        getSubmenuItems: () =>
                            yo(e, u, 'tablecellclass', (t) => e.execCommand('mceTableCellToggleClass', !1, t)),
                        onSetup: t.onSetupCellOrRow
                    }),
