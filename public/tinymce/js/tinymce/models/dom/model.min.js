...
!(function () {
    ...
    const ft = (e, t, o) => {
        ...
        qt = (e, t) =>
            ((e, t, o = y) =>
                o(t) ? C.none() : D(e, ne(t)) ? C.some(t) : ht(t, e.join(','), (e) => Ce(e, 'table') || o(e)))(
                ['td', 'th'],
                e,
                t
            ),
    ...
    const ps = (e, t, o, n) => {
        ...
        bs = hs(),
        vs = (e, t) =>
            ((e, t, o) => (o.length > 0 ? ((e, t, o, n) => n(e, t, o[0], o.slice(1)))(e, t, o, ps) : C.none()))(
                bs,
                (t, o) => e(o),
                t
            ),
        ...
        Ss = (e, t, o) =>
            wt(e, t).bind((t) => wt(e, o).bind((e) => vs(ys, [t, e]).map((o) => ({ first: t, last: e, table: o })))),
        Ts = (e, t, o, n, r) =>
                        ...
                        .bind((o) => {
                            const n = Ae(o)
                                .map(
                                    (e) =>
                                        !!pa(e) ||
                                        (!!((e, t) => D(['br', 'img', 'hr', 'input'], e.property().name(t)))(ha, e) &&
                                            'img' !== ne(e))
                                )
                                .getOr(!1);
                            return Ne(o).map((r) => {
        ...
        Sa = (e) =>
            A(e, (e, t) => (O(e, (e) => e.row === t.row) ? e : e.concat([t])), []).sort((e, t) => e.row - t.row),
        Ta = (e, t) => (o, n, r, s, l) => {
            const a = Sa(n),
                c = E(a, (e) => e.row),
                i = ((e, t, o, n, r, s, l) => {
                    ...
                    const f = [...a, ...u],
                        g = ((e, t) => (P(t, h) && nl(e.cells) ? x : (e, o, n) => !('th' === ne(e.element) && t[n])))(
                            i,
                            d
                        ),
                        p = (
                    ...
                    .map(
                        (t) => (
                            $r(e)
                                ...
                                : Vr(e)
                                  ? zc(t)
                                  : (Hr(e) || ((e) => r(e) && -1 !== e.indexOf('%'))(l.width)) && Bc(t),
                            ts(t),
                            be(t, 'data-mce-id'),
                            ((e, t) => {
                                N(dt(t, 'tr'), (t) => {
            ...
            bt(n, 'td,th', t).bind((n) =>
                bt(n, 'table', t).bind((s) =>
                    ((e, t) => ft(e, (e) => Ne(e).exists((e) => Re(e, t)), void 0).isSome())(r, s)
                        ? ((e, t, o) => Yi(e, t, o).bind((n) => Ji(e, t, n.element, n.offset, o, 20).map(e.fromSitus)))(
                              e,
                              t,
                              o
                          ).bind((e) =>
                                        ...
                                        g = Cs(t, n.selectedSelector).fold(
                                            ...
                                            (e) => {
                                                const o = (o) => () => {
                                                    ...
                                                    return s.fold(
                                                        () =>
                                                            Ss(t, n.firstSelectedSelector, n.lastSelectedSelector).map(
                                                                (e) => {
                                                                    const o =
