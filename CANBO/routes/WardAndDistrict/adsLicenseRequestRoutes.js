...
router.route('/area/:area').get(authorizePermissions('Phường', 'Quận'), getAdsLicenseRequestsByAssignedArea);
router.route('/dist/:dist/ward/:ward').get(authorizePermissions('Sở VH-TT'), getAdsLicenseRequestsByWardAndDistrict);
