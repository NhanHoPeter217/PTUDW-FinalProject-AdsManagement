...
$(document).ready(function () {
    $(document).on('submit', '#requestLicenseAdsBoardForm', function (e) {
        ...
        const contractEndDate = document.getElementsByClassName(`license_contractEndDate-${id}`).textContent;
        const contractStartDate = document.getElementsByClassName(`license_contractStartDate-${id}`).textContent;
    ...
    $(document).on('submit', '#requestEditAdsBoardForm', function (e) {
        ...
        const adsBoardImages = [];
        const adsBoardImage1 = document.getElementById(`edit_adsBoardImage_1-${adsObject}`).textContent;
        const adsBoardImage2 = document.getElementById(`edit_adsBoardImage_2-${adsObject}`).textContent;
        if (adsBoardImage1) adsBoardImages.push(adsBoardImage1);
        if (adsBoardImage2) adsBoardImages.push(adsBoardImage2);

        const contractEndDate = document.getElementsByClassName(`edit_contractEndDate-${adsObject}`).textContent;
